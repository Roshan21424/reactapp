...
static defaultProps={
  ...
  static propTypes={
   ...
   async componentDidMount(){
    ...
    const url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&from=2024-06-03&sortBy=publishedAt&apiKey=73fde9c68d5b46a79ff59891faf523a1&page=${this.state.page}&pageSize=${this.props.page}`
    this.setState(
      {
        loading:true
      }
